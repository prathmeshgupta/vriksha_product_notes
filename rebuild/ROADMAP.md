...
| R2 | Data layer (Supabase client, TypeScript types, auth) | In progress — code complete, `tsc -b --force` clean + manual ESLint-rule review clean; pending your local `npm run dev`/build/lint verification and commit |
